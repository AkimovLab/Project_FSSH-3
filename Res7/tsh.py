...
from recipes import fssh, fssh_v_plus, fssh_v_minus, fssh2, fssh3, gfsh
...
dyn_general = { "nsteps":NSTEPS, "ntraj":2000, "nstates":NSTATES,
...
if method_indx == 0:
    ...
    fssh_v_plus.load(dyn_general)  # FSSH, v+
elif method_indx == 20:
    fssh_v_minus.load(dyn_general)  # FSSH, v-
elif method_indx == 1:    
    fssh2.load(dyn_general) # FSSH-2
elif method_indx == 2:
    fssh3.load(dyn_general) # FSSH-3
    dyn_general["properties_to_save"].append("fssh3_average_errors")
elif method_indx == 3:
...
istates = [0.0, 0.5, 0.0, 0.5]
    
elec_params = {"verbosity":2, "init_dm_type":0,"ndia":NSTATES, "nadi":NSTATES, 
               "rep":1, "init_type":3, "istates":istates, "istate":NSTATES-1
              }
